...
urlpatterns = [
    ...
    path('crear-tour/', views.crear_tour, name='crear_tour'),
    path('editar-tour/<int:tour_id>/', views.editar_tour, name='editar_tour'),
path('eliminar-tour/<int:tour_id>/', views.eliminar_tour, name='eliminar_tour'),
